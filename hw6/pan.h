...
#define nstates5	104	/* :init: */
#define minseq5	178
#define maxseq5	280
#define endstate5	103

#define nstates4	81	/* invariant */
#define minseq4	98
#define maxseq4	177
#define endstate4	80

#define nstates3	23	/* handle4 */
#define minseq3	76
#define maxseq3	97
#define endstate3	22

#define nstates2	28	/* handle3 */
#define minseq2	49
#define maxseq2	75
#define endstate2	27

#define nstates1	28	/* handle2 */
#define minseq1	22
#define maxseq1	48
#define endstate1	27

#define nstates0	23	/* handle1 */
#define minseq0	0
#define maxseq0	21
#define endstate0	22
...
struct area { /* user defined type */
	unsigned north : 1;
	unsigned east : 1;
	unsigned south : 1;
	unsigned west : 1;
};
struct near_area { /* user defined type */
	int north;
	int east;
	int south;
	int west;
};
#define Pinit	((P5 *)this)
...
#define Pinvariant	((P4 *)this)
typedef struct P4 { /* invariant */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
	...
	unsigned changed : 1;
	uchar filled[11];
	uchar filled_copy[11];
	uchar i;
	uchar j;
	int next_area;
} P4;
#define Air4	(sizeof(P4) - Offsetof(P4, next_area) - 1*sizeof(int))

#define Phandle4	((P3 *)this)
typedef struct P3 { /* handle4 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Phandle3	((P2 *)this)
typedef struct P2 { /* handle3 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Phandle2	((P1 *)this)
typedef struct P1 { /* handle2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Phandle1	((P0 *)this)
typedef struct P0 { /* handle1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct State {
	...
	unsigned area_lock : 1;
	struct area areas[11];
	struct near_area near_areas[11];
#ifdef TRIX
